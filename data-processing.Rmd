...
## Results
With a very limited dataset of roughly 600 data records, the deep learning model ran into big issues with overfitting. However, with added dropout and gaussian nosise with L1 regularization, I was able to control the overtraining a little bit. The model accuracy and loss graphs are shown below:
